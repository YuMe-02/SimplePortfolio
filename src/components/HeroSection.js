...
const HeroSection = ({ 
  ...
  return (
    <div className="mb-16">
      ...
      <h1 className="text-4xl md:text-6xl font-extrabold leading-tight tracking-left mt-24">
      ...
      <p className="text-lg md:text-xl text-gray-600 font-light mt-16">
        {subtitle}
      </p>
      <p className="text-base leading-relaxed text-gray-700 max-w-lg mt-16">
        {description}
      </p>
    </div>
  );
